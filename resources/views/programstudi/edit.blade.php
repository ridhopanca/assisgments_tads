              ...
              <div class="kt_topbar_left">
                <h3 class="kt-subheader__title my-0">@isset($title)
                  ...
                  @if($errors->any())
									...
									@endif
									<form class="kt-form" method="post" action="{{ route('programstudi.update', $programstudi->id ) }}">
										@csrf
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="fakultas_id" name="fakultas_id">
                          ...
                          <option value="{{ $fk->id }}" {{ ( $fk->id == $programstudi->fakultas_id) ? 'selected' : '' }}>{{ $fk->nama_fakultas }}</option>
                          @endforeach
                        </select>
                      </div>
											<div class="form-group">
												<label>Nama Program Studi</label>
												<input type="text" class="form-control" name="nama_program_studi" aria-describedby="nama_program_studi" placeholder="Masukkan Nama Program Studi" value="{{ $programstudi->nama_program_studi }}">
											</div>
										</div>
										<div class="kt-portlet__foot pb-3">
											<div class="kt-form__actions ">
												<button type="submit" class="btn btn-primary">Update</button>
												<button type="button" class="btn btn-secondary" onclick="window.location='{{ route('programstudi.index') }}'">Batal</button>
											</div>
										</div>
									</form>
                </div>
