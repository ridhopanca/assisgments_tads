              ...
              <div class="kt_topbar_left">
                <h3 class="kt-subheader__title my-0">@isset($title)
                  ...
                  @if($errors->any())
									...
									@endif
									<form class="kt-form" method="post" action="{{ route('programstudi.store') }}">
										@csrf
                        ...
                        <select class="form-control" id="fakultas_id" name="fakultas_id">
                          ...
                          @endforeach
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" name="nama_program_studi" aria-describedby="nama_program_studi" placeholder="Masukkan Nama Program Studi" >
											</div>
										</div>
