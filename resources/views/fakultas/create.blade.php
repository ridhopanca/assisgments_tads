						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid py-0">
							...
							<div class="row">
								<div class="col-lg-12 bg-white" style="margin-top: -30px;">
									...
									<form class="kt-form" method="post"  action="{{ route('fakultas.store') }}">
										@csrf
										<div class="kt-portlet__body">
											<div class="form-group">
												<label>Nama Fakultas</label>
												<input type="text" class="form-control" name="nama_fakultas" aria-describedby="nama_fakultas" placeholder="Masukkan Nama Fakultas" >
											</div>
										</div>
